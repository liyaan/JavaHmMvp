...
import com.example.utils.component.more.BaseProvider;
import com.example.utils.component.more.ProviderCreator;
...
import com.liyaan.study.holder.HomeHolder;
...
public class HomeMoreFraction extends BaseMvpFraction<HomePresenter> implements HomeContract.View {
    ...
    private int page = 0;
    private BaseProvider<ArticleListBean> mProvider;
    @Override
...
//        mHomeProvider = new HomeProvider(this);
        mProvider= new ProviderCreator.Builder<ArticleListBean>(getFractionAbility())
                .register(ArticleListBean.class, HomeHolder.class).setData(mArticleListBean).create();
...
//                }
                if (page==0){
                    mProvider.refreshData(bean.getData().getDatas());
                }else{
                    mProvider.more(bean.getData().getDatas());
                }
