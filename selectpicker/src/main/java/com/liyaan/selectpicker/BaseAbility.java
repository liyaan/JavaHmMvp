...
public abstract class BaseAbility extends Ability {
  ...
  protected BaseAbility activity;
  ...
  public interface LifeCycleListener {
    ...
    void onActivityCreated(BaseAbility activity);

    void onActivityResumed(BaseAbility activity);

    void onActivityStarted(BaseAbility activity);

    void onActivityRestarted(BaseAbility activity);

    void onActivityPaused(BaseAbility activity);

    void onActivityStopped(BaseAbility activity);

    void onActivityDestroyed(BaseAbility activity);
