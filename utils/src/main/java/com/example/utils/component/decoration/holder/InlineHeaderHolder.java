 ...
 * @since 2021-04-14
 */
public class InlineHeaderHolder extends Holder {
    /**
     * 每一行中的头部文字
     */
     ...
     */
    public InlineHeaderHolder(Context context, Component itemView) {
        headerText = (Text) itemView.findComponentById(ResourceTable.Id_header_text);
        contentText = (Text) itemView.findComponentById(ResourceTable.Id_item_text);
